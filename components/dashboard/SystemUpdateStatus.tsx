...
export function UpdateStatus() {
    ...
    if (loading) {
        return (
            <div className="glass-panel p-6 rounded-2xl mb-8 flex items-center gap-4">
    ...
    return (
        <div
            className="glass-panel p-6 rounded-2xl mb-8 cursor-pointer transition-colors hover:bg-white/[0.07]"
        ...
        >
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-4 w-full md:w-auto">
                    <div className={`p-3 rounded-xl bg-white/5 ${isRebootRequired ? 'text-red-400 bg-red-500/10' :
                        hasUpdates ? 'text-blue-400 bg-blue-500/10' :
                            'text-green-400 bg-green-500/10'
                        }`}>
                        {isRebootRequired ? <AlertTriangle className="h-6 w-6" /> :
                            hasUpdates ? <Download className="h-6 w-6 animate-pulse" /> :
                ...
                {(hasUpdates || isRebootRequired) && (
                    <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto items-end md:items-center">
                        {isRebootRequired && (
                            <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-red-500/10 border border-red-500/20">
                                ...
                                <div className="flex flex-col">
                                    <span className="text-sm font-medium text-red-400">Reboot Needed</span>
                        ...
                        {hasUpdates && (
                            <div className={`flex items-center gap-3 px-4 py-3 rounded-xl border ${badgeColor}`}>
            ...
            <AnimatePresence>
                {expanded && hasUpdates && (
                    ...
                    >
                        <div className="mt-4 pt-4 border-t border-white/5 space-y-2 pl-2">
                            ...
                            {showPackages && data.updatePackages && (
                                <div className="mt-3 space-y-2 max-h-64 overflow-y-auto">
                                    ...
                                    {data.securityUpdates > 0 && data.securityPackagesList && (
                                        <>
                                            <div className="text-xs font-semibold text-red-400 mt-3 mb-2">
